...
class Movie(Video):
    ...
    def __init__(self, movie_title, votes, movie_storyline, poster_image, movie_trailer_youtube):
...
class Tv_show(Video):
	...
	def __init__(self, movie_title, tv_show_image, tv_show_trailer_youtube):
		Video.__init__(self, movie_title)
		self.tv_show_image_url = tv_show_image
		self.trailer_youtube_url = tv_show_trailer_youtube
